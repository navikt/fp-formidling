...
public class SvangerskapspengerInnvilgelseDokumentdataMapperTest {
    ...
    public void skal_mappe_felter_for_førstegangsbehandling() {
        ...
        assertThat(dokumentdata.getBruttoBeregningsgrunnlag()).isEqualTo(GRUNNBELØP * 6);
    ...
    public void skal_mappe_selvstendig_næringsdrivende_når_det_er_i_første_periode() {
        ...
        assertThat(dokumentdata.getSelvstendigNæringsdrivende().getÅrsinntekt()).isEqualTo(BRUTTO_BERENINGSGRUNNLAG_SN);
    ...
    public void skal_mappe_frilanser_når_det_er_i_første_periode() {
        ...
        assertThat(dokumentdata.getFrilanser().getMånedsinntekt()).isEqualTo(BRUTTO_BERENINGSGRUNNLAG_FL / 12);
    }
    ...
    private FamilieHendelse opprettFamilieHendelse(LocalDate termindato) {
        return new FamilieHendelse(BigInteger.ONE, true, true, FamilieHendelseType.TERMIN,
