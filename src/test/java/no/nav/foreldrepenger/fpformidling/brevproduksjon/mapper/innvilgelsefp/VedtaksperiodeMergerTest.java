...
import static no.nav.foreldrepenger.fpformidling.brevproduksjon.mapper.innvilgelsefp.VedtaksperiodeMerger.likeAktiviteter;
...
class VedtaksperiodeMergerTest {
    ...
    void skal_slå_sammen_perioder_som_er_sammenhengende() {
        ...
        var utbetalingsperiode2 = Vedtaksperiode.ny()
            ...
            .build();
        var utbetalingsperiode3 = Vedtaksperiode.ny()
        ...
        // Act
        var resultat = VedtaksperiodeMerger.mergePerioder(asList(utbetalingsperiode1, utbetalingsperiode2, utbetalingsperiode3));
    ...
    void skal_ikke_slå_sammen_perioder_med_forskjellig_dagsats() {
        ...
        // Act
        var resultat = VedtaksperiodeMerger.mergePerioder(asList(utbetalingsperiode1, utbetalingsperiode2));
    ...
    void skal_returnere_enkeltperiode() {
        // Arrange
        var utbetalingsperiode = of(Vedtaksperiode.ny()
            .medPeriodeFom(PERIODE1_FOM, Språkkode.NB)
            .medPeriodeTom(PERIODE1_TOM, Språkkode.NB)
            .medAntallTapteDager(5, BigDecimal.ZERO)
            .build());
        ...
        // Act
        var resultat = VedtaksperiodeMerger.mergePerioder(utbetalingsperiode);
    ...
    void skal_finne_like_aktiviteter_når_ikke_satt() {
        assertThat(likeAktiviteter(Vedtaksperiode.ny().build(), Vedtaksperiode.ny().build())).isTrue();
    }

    @Test
    void skal_finne_at_aktiviteter_er_ulike() {
        var utbetalingsperiode1 = Vedtaksperiode.ny().build();
        var utbetalingsperiode2 = Vedtaksperiode.ny().medNæring(Næring.ny().build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();

        utbetalingsperiode2 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().build())).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();

        utbetalingsperiode2 = Vedtaksperiode.ny().medAnnenAktivitet(of(AnnenAktivitet.ny().build())).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();
    }
    ...
    void skal_finne_like_aktiviteter_kompleks_næring() {
        var utbetalingsperiode1 = Vedtaksperiode.ny().build();
        var utbetalingsperiode2 = Vedtaksperiode.ny().build();

        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isTrue();

        utbetalingsperiode1 = Vedtaksperiode.ny().medNæring(Næring.ny().build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();

        utbetalingsperiode2 = Vedtaksperiode.ny().medNæring(Næring.ny().medSistLignedeÅr(2020).build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();

        utbetalingsperiode1 = Vedtaksperiode.ny().medNæring(Næring.ny().medSistLignedeÅr(2020).build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isTrue();
        ...
        utbetalingsperiode1 = Vedtaksperiode.ny().medNæring(Næring.ny().medSistLignedeÅr(2019).medAktivitetDagsats(100).build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();

        utbetalingsperiode2 = Vedtaksperiode.ny().medNæring(Næring.ny().medSistLignedeÅr(2019).medAktivitetDagsats(100).build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isTrue();

        utbetalingsperiode2 = Vedtaksperiode.ny().medNæring(Næring.ny().medSistLignedeÅr(2019).medAktivitetDagsats(200).build()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();
    }

    @Test
    void skal_finne_like_aktiviteter_kompleks_annen_aktivitet() {
        var utbetalingsperiode1 = Vedtaksperiode.ny().medAnnenAktivitet(of()).build();
        var utbetalingsperiode2 = Vedtaksperiode.ny().medAnnenAktivitet(of()).build();
    ...
    void skal_finne_like_aktiviteter_kompleks_arbeidsforhold() {
        var utbetalingsperiode1 = Vedtaksperiode.ny().medArbeidsforhold(of()).build();
        var utbetalingsperiode2 = Vedtaksperiode.ny().medArbeidsforhold(of()).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isTrue();
        ...
        utbetalingsperiode1 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medArbeidsgiverNavn("navn1").build())).build();
        utbetalingsperiode2 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medArbeidsgiverNavn("navn1").build())).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isTrue();

        utbetalingsperiode1 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medArbeidsgiverNavn("navn1").build())).build();
        utbetalingsperiode2 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medArbeidsgiverNavn("navn2").build())).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();

        utbetalingsperiode1 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medAktivitetDagsats(1).build())).build();
        utbetalingsperiode2 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medAktivitetDagsats(1).build())).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isTrue();

        utbetalingsperiode1 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medAktivitetDagsats(1).build())).build();
        utbetalingsperiode2 = Vedtaksperiode.ny().medArbeidsforhold(of(Arbeidsforhold.ny().medAktivitetDagsats(2).build())).build();
        assertThat(likeAktiviteter(utbetalingsperiode1, utbetalingsperiode2)).isFalse();
    }
    ...
    void skal_slå_sammen_perioder_med_forskjellige_årsaker_som_er_regnet_som_like() {
        ...
        var utbetalingsperiode3 = Vedtaksperiode.ny()
            ...
            .build();
        var utbetalingsperiode4 = Vedtaksperiode.ny()
        ...
        // Act
        var resultat = VedtaksperiodeMerger.mergePerioder(
