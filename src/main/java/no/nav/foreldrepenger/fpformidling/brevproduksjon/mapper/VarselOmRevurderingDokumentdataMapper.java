...
import no.nav.foreldrepenger.fpformidling.integrasjon.fpsak.dto.behandling.BrevGrunnlag.FagsakYtelseType;
...
public class VarselOmRevurderingDokumentdataMapper implements DokumentdataMapper {
    ...
    private Optional<String> finnTermindato(BrevGrunnlag.FamilieHendelse familieHendelse, Språkkode språkkode) {
