...
public class DokgenLanseringTjeneste {
    ...
    private static final Map<DokumentMalType, DokumentMalType> OVERSTYRE_MAL_PROD = new HashMap<>();
    static {
        OVERSTYRE_MAL_PROD.put(DokumentMalType.VARSEL_OM_REVURDERING_DOK, DokumentMalType.VARSEL_OM_REVURDERING);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.INFO_OM_HENLEGGELSE_DOK, DokumentMalType.INFO_OM_HENLEGGELSE);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.INNSYN_SVAR_DOK, DokumentMalType.INNSYN_SVAR);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.KLAGE_HJEMSENDT_FRITEKST, DokumentMalType.KLAGE_HJEMSENDT);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.KLAGE_OMGJORT_FRITEKST, DokumentMalType.KLAGE_OMGJORT);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.KLAGE_OVERSENDT_FRITEKST, DokumentMalType.KLAGE_OVERSENDT);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.KLAGE_STADFESTET_FRITEKST, DokumentMalType.KLAGE_STADFESTET);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.FRITEKSTBREV_DOK, DokumentMalType.FRITEKSTBREV);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.ANKE_OMGJORT_FRITEKST, DokumentMalType.ANKE_OMGJORT);
        OVERSTYRE_MAL_PROD.put(DokumentMalType.ANKE_OPPHEVET_FRITEKST, DokumentMalType.ANKE_OPPHEVET);
