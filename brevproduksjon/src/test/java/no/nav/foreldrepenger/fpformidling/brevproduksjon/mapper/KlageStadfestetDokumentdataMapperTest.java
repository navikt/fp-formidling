...
public class KlageStadfestetDokumentdataMapperTest {
    ...
    private KlageStadfestetDokumentdataMapper dokumentdataMapper;

    @BeforeEach
    public void before() {
        dokumentData = lagStandardDokumentData(DokumentMalType.KLAGE_STADFESTET);
        when(brevParametere.getKlagefristUker()).thenReturn(6);
        dokumentdataMapper = new KlageStadfestetDokumentdataMapper(brevParametere, domeneobjektProvider);
    }
    ...
    public void skal_mappe_felter_for_brevet() {
        ...
        // Act
        KlageStadfestetDokumentdata dokumentdata = dokumentdataMapper.mapTilDokumentdata(dokumentFelles, dokumentHendelse, behandling, false);
