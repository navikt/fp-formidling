...
import static no.nav.foreldrepenger.fpformidling.datamapper.util.BrevMapperUtil.erEndringssøknad;
...
import no.nav.foreldrepenger.fpformidling.datamapper.domene.MottattdokumentMapper;
