...
class EngangsstønadInnvilgelseDokumentdataMapperTest {
    ...
    void case_med_endret_sats_blir_satt_riktig() {
        ...
        var behandling = defaultBuilder().fagsakYtelseType(BrevGrunnlag.FagsakYtelseType.ENGANGSTØNAD)
    ...
    private BrevGrunnlag.FamilieHendelse lagFamHendelse(int antallBarn) {
