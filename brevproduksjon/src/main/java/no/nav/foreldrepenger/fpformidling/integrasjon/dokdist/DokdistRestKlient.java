...
@ApplicationScoped
@RestClientConfig(tokenConfig = TokenFlow.STS_CC, endpointProperty = "dokdist.rest.base.url", endpointDefault = "http://dokdistfordeling.teamdokumenthandtering/rest/v1")
