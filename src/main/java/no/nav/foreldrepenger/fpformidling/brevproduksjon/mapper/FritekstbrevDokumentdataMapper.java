...
public class FritekstbrevDokumentdataMapper implements DokumentdataMapper {
    ...
    private String finnOverskrift(DokumentHendelse hendelse, BrevGrunnlag.Behandlingsresultat behandlingsresultat) {
        return hendelse.getTittel() != null && !hendelse.getTittel().isEmpty() ? hendelse.getTittel() : behandlingsresultat.fritekst().overskrift();
    }

    private String finnBrødtekst(DokumentHendelse hendelse, BrevGrunnlag.Behandlingsresultat behandlingsresultat) {
