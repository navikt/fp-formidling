...
public class KlageAvvistDokumentdataMapper implements DokumentdataMapper {
    ...
    private String getLovhjemler(BrevGrunnlag.KlageBehandling klage, Språkkode språkkode) {
    ...
    private Set<String> getAvvistGrunner(BrevGrunnlag.KlageBehandling klage) {
