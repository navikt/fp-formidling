...
class AvslåttAktivitetMapperTest {
    ...
    private List<BrevGrunnlag.SvangerskapspengerUttak.UttakArbeidsforhold> getSvpUttakResultatArbeidsforhold() {
        ...
        var arbeidsforhold2 = svangerskapspengerUttakArbeidsforhold().arbeidsforholdIkkeOppfyltÅrsak(
            ...
            .arbeidType(BrevGrunnlag.UttakArbeidType.SELVSTENDIG_NÆRINGSDRIVENDE)
            .build();

        var arbeidsforhold3 = svangerskapspengerUttakArbeidsforhold().arbeidsforholdIkkeOppfyltÅrsak(
            ArbeidsforholdIkkeOppfyltÅrsak.ARBEIDSGIVER_KAN_TILRETTELEGGE.getKode()).arbeidType(BrevGrunnlag.UttakArbeidType.FRILANS).build();
