...
public interface DokumentMapperFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FP-875835", feilmelding = "Ugyldig behandlingstype %s for brev med malkode HENLEG", logLevel = LogLevel.ERROR)
    ...
    @TekniskFeil(feilkode = "FP-724872", feilmelding = "Feil ved produksjon av opphørdokument: Klarte ikke utlede opphørsdato fra uttaksplanen. Påkrevd når personstatus = 'DØD'", logLevel = LogLevel.ERROR)
    Feil ingenOpphørsdatoVedPersonstatusDød();

    @TekniskFeil(feilkode = "FP-743452", feilmelding = "Feil ved produksjon av opphørdokument: Klarte ikke utlede startdato fra det opprinnelige vedtaket. Påkrevd når personstatus = 'DØD", logLevel = LogLevel.ERROR)
