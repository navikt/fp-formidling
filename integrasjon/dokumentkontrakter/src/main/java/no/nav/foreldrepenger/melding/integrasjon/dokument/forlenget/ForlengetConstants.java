package no.nav.foreldrepenger.melding.integrasjon.dokument.forlenget;
...
public final class ForlengetConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.melding.integrasjon.dokumentkontrakter.dokument.forlenget.v1";
