package no.nav.foreldrepenger.integrasjon.dokument.avbruttbehandling;
...
public final class AvbruttbehandlingConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.integrasjon.dokument.avbruttbehandling.v1";
