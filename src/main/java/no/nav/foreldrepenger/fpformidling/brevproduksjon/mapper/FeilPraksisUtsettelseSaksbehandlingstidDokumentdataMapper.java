...
@ApplicationScoped
@DokumentMalTypeRef(DokumentMalType.FORELDREPENGER_FEIL_PRAKSIS_UTSETTELSE_FORLENGET_SAKSBEHANDLINGSTID)
public class FeilPraksisUtsettelseSaksbehandlingstidDokumentdataMapper implements DokumentdataMapper {

    @Override
    public String getTemplateNavn() {
        return "foreldrepenger-feil-praksis-utsettelse-forlenget-saksbehandlingstid";
    }
