package no.nav.foreldrepenger.melding.integrasjon.dokument.klage.ytelsesvedtak.opphevet;
...
public final class KlageYtelsesvedtakOpphevetConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.melding.integrasjon.dokumentkontrakter.dokument.klage.ytelsesvedtak.opphevet.v1";
