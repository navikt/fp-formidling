...
class KlageAvvistDokumentdataMapperTest {
    ...
    void skal_mappe_felter_for_vanlig_behandling() {
        ...
        var klageFormkrav = klageFormkravResultat()
            .påklagdBehandlingType(BrevGrunnlag.BehandlingType.FØRSTEGANGSSØKNAD)
            .avvistÅrsaker(of(BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.KLAGER_IKKE_PART))
            .build();
    ...
    void skal_mappe_felter_for_tilbakekreving_med_alle_avvist_grunner_og_spesialhåndtere_for_sent_og_ikke_signert() {
        // Arrange
        var klageFormkrav = klageFormkravResultat()
            .påklagdBehandlingType(BrevGrunnlag.BehandlingType.TILBAKEKREVING)
            .avvistÅrsaker(of(
                BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.KLAGET_FOR_SENT,
                BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.KLAGER_IKKE_PART,
                BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.KLAGE_UGYLDIG,
                BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.IKKE_KONKRET,
                BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.IKKE_PÅKLAGD_VEDTAK,
                BrevGrunnlag.KlageBehandling.KlageAvvistÅrsak.IKKE_SIGNERT
            ))
            .build();
