...
class ForeldrepengerOpphørDokumentdataMapperTest {
    ...
    void skal_mappe_felter_for_brev_til_bruker() {
        ...
        var dokumentHendelse = lagStandardHendelseBuilder().medDokumentMal(no.nav.foreldrepenger.fpformidling.typer.DokumentMalEnum.FORLENGET_SAKSBEHANDLINGSTID_MEDL).build();
