...
import no.nav.foreldrepenger.fpformidling.integrasjon.dokgen.v1.FpDokgenRestKlient;
...
class FpDokgenRestKlientTest {
    ...
    @BeforeEach
    void setup() {
        this.klient = new FpDokgenRestKlient(restClient);
    }
