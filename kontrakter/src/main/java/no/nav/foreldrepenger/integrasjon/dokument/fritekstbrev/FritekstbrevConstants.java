package no.nav.foreldrepenger.integrasjon.dokument.fritekstbrev;
...
public final class FritekstbrevConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.integrasjon.dokument.fritekstbrev.v1";
