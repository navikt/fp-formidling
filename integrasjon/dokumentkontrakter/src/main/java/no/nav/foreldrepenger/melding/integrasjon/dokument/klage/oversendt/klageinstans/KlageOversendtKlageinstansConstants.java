package no.nav.foreldrepenger.melding.integrasjon.dokument.klage.oversendt.klageinstans;
...
public final class KlageOversendtKlageinstansConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.melding.integrasjon.dokumentkontrakter.dokument.klage.oversendt.klageinstans.v1";
