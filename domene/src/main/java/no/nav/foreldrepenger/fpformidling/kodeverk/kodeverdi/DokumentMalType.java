...
public enum DokumentMalType implements Kodeverdi {
    ...
    FORELDREPENGER_INFOBREV_TIL_ANNEN_FORELDER(DokumentMalTypeKode.FORELDREPENGER_INFO_TIL_ANNEN_FORELDER, "Informasjonsbrev til den andre forelderen"),
    ...
    @Deprecated
    FRITEKSTBREV_DOK(DokumentMalTypeKode.FRITEKSTBREV_DOK, "Fritekstbrev"), //NOSONAR
    @Deprecated
    ENGANGSSTØNAD_INNVILGELSE_DOK(DokumentMalTypeKode.ENGANGSSTØNAD_INNVILGELSE_DOK, "Positivt vedtaksbrev"), //NOSONAR
    @Deprecated
    ENGANGSSTØNAD_AVSLAG_DOK(DokumentMalTypeKode.ENGANGSSTØNAD_AVSLAG_DOK, "Avslagsbrev"), //NOSONAR
    @Deprecated
    FORELDREPENGER_INNVILGELSE_DOK(DokumentMalTypeKode.FORELDREPENGER_INNVILGELSE_DOK, "Innvilgelsesbrev Foreldrepenger"), //NOSONAR
    @Deprecated
    FORELDREPENGER_AVSLAG_DOK(DokumentMalTypeKode.FORELDREPENGER_AVSLAG_DOK, "Avslagsbrev Foreldrepenger"), //NOSONAR
    @Deprecated
    FORELDREPENGER_OPPHØR_DOK(DokumentMalTypeKode.FORELDREPENGER_OPPHØR_DOK, "Opphør brev"), //NOSONAR
    @Deprecated
    FORELDREPENGER_INFOBREV_TIL_ANNEN_FORELDER_DOK(DokumentMalTypeKode.FORELDREPENGER_INFOBREV_TIL_ANNEN_FORELDER_DOK, "Informasjonsbrev til den andre forelderen"), //NOSONAR
    @Deprecated
    SVANGERSKAPSPENGER_INNVILGELSE_FRITEKST(DokumentMalTypeKode.SVANGERSKAPSPENGER_INNVILGELSE_FRITEKST, "Innvilgelsesbrev svangerskapspenger"), //NOSONAR
    @Deprecated
    INNHENTE_OPPLYSNINGER_DOK(DokumentMalTypeKode.INNHENTE_OPPLYSNINGER_DOK, "Innhent dokumentasjon"), //NOSONAR
    @Deprecated
    VARSEL_OM_REVURDERING_DOK(DokumentMalTypeKode.VARSEL_OM_REVURDERING_DOK, "Varsel om revurdering"), //NOSONAR
    @Deprecated
    INFO_OM_HENLEGGELSE_DOK(DokumentMalTypeKode.INFO_OM_HENLEGGELSE_DOK, "Behandling henlagt"), //NOSONAR
    @Deprecated
    INNSYN_SVAR_DOK(DokumentMalTypeKode.INNSYN_SVAR_DOK, "Svar på innsynskrav"), //NOSONAR
    @Deprecated
    IKKE_SØKT_DOK(DokumentMalTypeKode.IKKE_SØKT_DOK, "Ikke mottatt søknad"), //NOSONAR
    @Deprecated
    INGEN_ENDRING_DOK(DokumentMalTypeKode.INGEN_ENDRING_DOK, "Uendret utfall"), //NOSONAR
    @Deprecated
    FORLENGET_SAKSBEHANDLINGSTID_DOK(DokumentMalTypeKode.FORLENGET_SAKSBEHANDLINGSTID_DOK, "Forlenget saksbehandlingstid"), //NOSONAR
    @Deprecated
    FORLENGET_SAKSBEHANDLINGSTID_MEDL_DOK(DokumentMalTypeKode.FORLENGET_SAKSBEHANDLINGSTID_MEDL_DOK, "Forlenget saksbehandlingstid - medlemskap"), //NOSONAR
    @Deprecated
    ...
    @Deprecated
    KLAGE_HJEMSENDT_FRITEKST(DokumentMalTypeKode.KLAGE_HJEMSENDT_FRITEKST, "Klage hjemsendt/opphevet"), //NOSONAR
    @Deprecated
    KLAGE_OMGJORT_DOK(DokumentMalTypeKode.KLAGE_OMGJORT_DOK, "Vedtak om medhold"), //NOSONAR
    @Deprecated
    KLAGE_OMGJORT_FRITEKST(DokumentMalTypeKode.KLAGE_OMGJORT_FRITEKST, "Vedtak om omgjøring av klage"), //NOSONAR
    @Deprecated
    KLAGE_OVERSENDT_DOK(DokumentMalTypeKode.KLAGE_OVERSENDT_DOK,"Overføring til NAV Klageinstans"), //NOSONAR
    @Deprecated
    KLAGE_OVERSENDT_FRITEKST(DokumentMalTypeKode.KLAGE_OVERSENDT_FRITEKST, "Klage oversendt til klageinstans"), //NOSONAR
    @Deprecated
    KLAGE_STADFESTET_DOK(DokumentMalTypeKode.KLAGE_STADFESTET_DOK, "Vedtak om stadfestelse"), //NOSONAR
    @Deprecated
    KLAGE_STADFESTET_FRITEKST(DokumentMalTypeKode.KLAGE_STADFESTET_FRITEKST, "Vedtak om stadfestelse i klagesak"), //NOSONAR
    @Deprecated
    ANKE_OMGJORT_FRITEKST(DokumentMalTypeKode.ANKE_OMGJORT_FRITEKST, "Vedtak om omgjøring i ankesak"), //NOSONAR
    @Deprecated
    ...
    @Deprecated
    KLAGE_STADFESTET(DokumentMalTypeKode.KLAGE_STADFESTET, "Vedtak om stadfestelse i klagesak"), //NOSONAR
    @Deprecated
    KLAGE_HJEMSENDT(DokumentMalTypeKode.KLAGE_HJEMSENDT, "Klage hjemsendt/opphevet"), //NOSONAR
