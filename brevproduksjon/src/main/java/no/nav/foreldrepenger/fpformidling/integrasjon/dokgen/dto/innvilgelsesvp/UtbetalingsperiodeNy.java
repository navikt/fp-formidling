...
public class UtbetalingsperiodeNy {
    ...
    public boolean equals(Object object) {
        ...
        var that = (UtbetalingsperiodeNy) object;
    ...
    public static class Builder {
        private UtbetalingsperiodeNy kladd;

        private Builder() {
            this.kladd = new UtbetalingsperiodeNy();
        }
        ...
        public UtbetalingsperiodeNy build() {
            return this.kladd;
        }
    }
