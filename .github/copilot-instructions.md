...
- bestillDokument: Produces PDF letter, journals and distributes this before sending confirmation to `fp-sak`.
- forhåndsvisDokument: returns PDF preview document
- genererBrevHtml: return HTML preview for further editing in `fp-sak`
