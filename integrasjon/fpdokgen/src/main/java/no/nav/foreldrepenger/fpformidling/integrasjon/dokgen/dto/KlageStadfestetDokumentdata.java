...
public class KlageStadfestetDokumentdata extends Dokumentdata {
    ...
    public boolean equals(Object object) {
        ...
        var that = (KlageStadfestetDokumentdata) object;
    ...
    public static class Builder {
        private KlageStadfestetDokumentdata kladd;

        private Builder() {
            this.kladd = new KlageStadfestetDokumentdata();
        }
        ...
        public KlageStadfestetDokumentdata build() {
            return this.kladd;
        }
    }
}