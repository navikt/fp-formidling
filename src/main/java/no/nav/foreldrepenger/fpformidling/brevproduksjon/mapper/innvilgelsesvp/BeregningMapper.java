...
public final class BeregningMapper {
    ...
    public static String utledLovhjemmelForBeregning(BeregningsgrunnlagDto beregningsgrunnlag, BrevGrunnlag behandling) {
        var revurdering = behandling.erRevurdering();
        var behandlingsresultat = behandling.behandlingsresultat();
        var innvilget = BrevGrunnlag.Behandlingsresultat.BehandlingResultatType.INNVILGET.equals(behandlingsresultat.behandlingResultatType());
