package no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp;

import static no.nav.foreldrepenger.fpformidling.behandling.KonsekvensForYtelsen.ENDRING_I_BEREGNING;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.felles.BeregningsresultatMapper.finnAntallRefusjonerTilArbeidsgivere;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.felles.BeregningsresultatMapper.finnMånedsbeløp;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.felles.BeregningsresultatMapper.harBrukerAndel;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.AvslagsperiodeMapper.mapAvslagsperioder;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.AvslåttAktivitetMapper.mapAvslåtteAktiviteter;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.erMilitærSivil;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.finnSeksG;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.getAvkortetPrÅrSVP;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.inntektOverSeksG;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.mapArbeidsforhold;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.mapFrilanser;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.mapSelvstendigNæringsdrivende;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.BeregningMapper.utledLovhjemmelForBeregning;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.NaturalytelseMapper.mapNaturalytelser;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.UtbetalingsperiodeMapper.finnStønadsperiodeTom;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.UtbetalingsperiodeMapper.mapUtbetalingsperioder;
import static no.nav.foreldrepenger.fpformidling.brevmapper.brev.innvilgelsesvp.UttaksperiodeMapper.mapUttaksaktivteterMedPerioder;
import static no.nav.foreldrepenger.fpformidling.datamapper.domene.BehandlingMapper.erEndretFraAvslått;
import static no.nav.foreldrepenger.fpformidling.datamapper.domene.BehandlingMapper.erRevurderingPgaEndretBeregningsgrunnlag;
import static no.nav.foreldrepenger.fpformidling.datamapper.domene.BehandlingMapper.erTermindatoEndret;
import static no.nav.foreldrepenger.fpformidling.datamapper.domene.MottattdokumentMapper.finnSøknadsdatoFraMottatteDokumenter;
