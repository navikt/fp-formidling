...
public class UndermalInkluderingMapperTest {
    ...
    public void skal_inkludere__utbetaling_når_det_er_innvilget_resultat_og_mer_enn_en_periode() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).build();
        Utbetalingsperiode utbetalingsperiode2 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).build();
    ...
    public void skal_inkludere_utbetaling_når_det_er_innvilget_resultat_og_en_periode_med_næring_og_uten_gradering_og_uten_en_av_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medNæring(Næring.ny().medGradering(false).build()).build();
    ...
    public void skal_ikke_inkludere_utbetaling_når_det_er_innvilget_resultat_og_en_periode_uten_gradering_med_en_av_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medNæring(Næring.ny().medGradering(false).build()).build();
    ...
    public void skal_ikke_inkludere_utbetaling_når_det_er_innvilget_resultat_og_en_periode_med_gradering_uten_en_av_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medNæring(Næring.ny().medGradering(true).build()).build();
    ...
    public void skal_inkludere_utbetaling_når_det_er_innvilget_resultat_og_en_periode_med_arbeidsforhold_og_uten_gradering_og_uten_en_av_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medArbeidsforhold(of(Arbeidsforhold.ny().medGradering(false).build())).build();
    ...
    public void skal_inkludere_utbetaling_når_det_er_innvilget_resultat_og_en_periode_med_annen_aktivitet_og_uten_gradering_og_uten_en_av_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medAnnenAktivitet(of(AnnenAktivitet.ny().medGradering(false).build())).build();
    ...
    public void skal_inkludere_gradering_når_det_er_innvilget_resultat_og_nøyaktig_en_periode_med_gitt_årsak() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).build();
    ...
    public void skal_ikke_inkludere_gradering_når_det_er_innvilget_resultat_og_nøyaktig_en_periode_uten_gitt_årsak() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).build();
    ...
    public void skal_inkludere_gradering_når_det_er_innvilget_resultat_og_nøyaktig_en_periode_med_gradering() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medAnnenAktivitet(of(AnnenAktivitet.ny().medGradering(true).build())).build();
    ...
    public void skal_ikke_inkludere_gradering_når_det_er_innvilget_resultat_og_nøyaktig_en_periode_uten_gradering() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medAnnenAktivitet(of(AnnenAktivitet.ny().medGradering(false).build())).build();
    ...
    public void skal_ikke_inkludere_gradering_når_det_er_innvilget_resultat_og_mer_enn_en_periode() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).build();
        Utbetalingsperiode utbetalingsperiode2 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2011")).build();
    ...
    public void skal_inkludere_innvilget_når_det_ikke_er_konsekvens_for_ytelse_endring_i_beregning_og_har_mer_enn_en_periode_der_minst_en_er_innvilget() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medInnvilget(true).build();
        Utbetalingsperiode utbetalingsperiode2 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2011")).medInnvilget(false).build();
    ...
    public void skal_ikke_inkludere_innvilget_når_det_er_ingen_innvilgede_perioder() {
        ...
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medInnvilget(false).build();
        Utbetalingsperiode utbetalingsperiode2 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2011")).medInnvilget(false).build();
    ...
    public void skal_ikke_inkludere_innvilget_når_det_er_bare_en_periode_uten_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("1234")).medInnvilget(true).build();
    ...
    public void skal_inkludere_innvilget_når_det_er_bare_en_periode_med_gitte_årsaker() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medInnvilget(true).build();
    ...
    public void skal_inkludere_avslag_når_det_er_minst_en_avslått_periode_og_konsekvens_for_ytelse_ikke_er_endring_i_beregning() {
        // Arrange
        Utbetalingsperiode utbetalingsperiode1 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medInnvilget(false).build();
        Utbetalingsperiode utbetalingsperiode2 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medInnvilget(true).build();
    ...
    public void skal_ikke_inkludereNyeOpplysningerUtbet_når_flere_perioder() {
        ...
        Utbetalingsperiode utbetalingsperiode = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2010")).medInnvilget(true).build();
        Utbetalingsperiode utbetalingsperiode2 = Utbetalingsperiode.ny().medÅrsak(Årsak.of("2011")).medInnvilget(true).build();
