package no.nav.foreldrepenger.fpformidling.datamapper.domene;

import static no.nav.foreldrepenger.fpformidling.datamapper.domene.BehandlingMapper.ENDRING_BEREGNING_OG_UTTAK;
