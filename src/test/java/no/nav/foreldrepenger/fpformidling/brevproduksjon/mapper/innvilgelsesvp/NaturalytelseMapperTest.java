...
class NaturalytelseMapperTest {
    ...
    private static final Integer DAGSATS = 1000;
    ...
    void skal_ikke_utlede_naturalytelse_som_starter_med_første_periode() {
        ...
        var beregningsgrunnlag = getBeregningsgrunnlag(ARBEIDSGIVER, BigDecimal.valueOf(1000), null, of(PeriodeÅrsakDto.NATURALYTELSE_BORTFALT), false);
    ...
    void skal_utlede_at_naturalytelse_bortfaller_når_årsak_er_bortfaller() {
        ...
        var beregningsgrunnlag = getBeregningsgrunnlag(ARBEIDSGIVER, BigDecimal.valueOf(1000), null, of(PeriodeÅrsakDto.NATURALYTELSE_BORTFALT), true);
    ...
    void skal_utlede_at_naturalytelse_tilkommer_når_årsak_er_tilkommer() {
        // Arrange
        var tilkjentYtelseFP = gettilkjentYtelseFP(ARBEIDSGIVER, true);
        var beregningsgrunnlag = getBeregningsgrunnlag(ARBEIDSGIVER, null, BigDecimal.valueOf(1000), of(PeriodeÅrsakDto.NATURALYTELSE_TILKOMMER), true);
    ...
    private TilkjentYtelseDagytelseDto gettilkjentYtelseFP(Arbeidsgiver arbeidsgiver, boolean inkluderePeriode2) {
        var andel = new TilkjentYtelseDagytelseDto.TilkjentYtelseAndelDto(arbeidsgiver.arbeidsgiverReferanse(), 0, 10,
            TilkjentYtelseDagytelseDto.Aktivitetstatus.ARBEIDSTAKER, null, null, null);

        var resultatPeriode1 = new TilkjentYtelseDagytelseDto.TilkjentYtelsePeriodeDto(PERIODE1_FOM, PERIODE1_TOM, DAGSATS, of(andel));
        var resultatPeriode2 = new TilkjentYtelseDagytelseDto.TilkjentYtelsePeriodeDto(PERIODE2_FOM, PERIODE2_TOM, DAGSATS, of(andel));
    ...
    private BeregningsgrunnlagDto getBeregningsgrunnlag(Arbeidsgiver arbeidsgiver,
        ...
        var andel = new BeregningsgrunnlagAndelDto((long) DAGSATS, AktivitetStatusDto.ARBEIDSTAKER, null, null, false, OpptjeningAktivitetDto.ARBEID,
            PERIODE1_FOM, PERIODE2_TOM, new BgAndelArbeidsforholdDto(arbeidsgiver.arbeidsgiverReferanse(), null, naturalytelseBortfaller, naturalytelseTilkommer), false);
        var periode1 = new BeregningsgrunnlagPeriodeDto((long) DAGSATS, null, null, periodeÅrsaker, PERIODE1_FOM, PERIODE1_TOM, List.of(andel));
        var periode2 = new BeregningsgrunnlagPeriodeDto((long) DAGSATS, null, null, periodeÅrsaker, PERIODE2_FOM, PERIODE2_TOM, List.of(andel));
        ...
        return new BeregningsgrunnlagDto(List.of(AktivitetStatusDto.ARBEIDSTAKER), null, BigDecimal.valueOf(DAGSATS * 6), perioder, false,
            false);
    }
}
