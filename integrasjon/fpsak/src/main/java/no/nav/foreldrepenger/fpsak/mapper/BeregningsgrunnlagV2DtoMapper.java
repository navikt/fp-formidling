...
public class BeregningsgrunnlagV2DtoMapper {
    ...
    public static Beregningsgrunnlag mapBeregningsgrunnlagFraDto(BeregningsgrunnlagDto dto, UnaryOperator<String> hentNavn) {
        ...
        dto.aktivitetstatusListe().stream().map(BeregningsgrunnlagV2DtoMapper::mapBeregningsgrunnlagAktivitetStatusFraDto).forEach(builder::leggTilBeregningsgrunnlagAktivitetStatus);
