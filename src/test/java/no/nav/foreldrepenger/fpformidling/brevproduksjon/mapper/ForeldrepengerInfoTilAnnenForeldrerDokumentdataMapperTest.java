...
class ForeldrepengerInfoTilAnnenForeldrerDokumentdataMapperTest {
    ...
    void mapInfoTilAnnenForelder() {
        ...
        var behandling = defaultBuilder()
            ...
            .behandlingÅrsakTyper(List.of(BrevGrunnlag.BehandlingÅrsakType.INFOBREV_BEHANDLING))
            .foreldrepengerUttak(foreldrepengerUttakData)
            .build();
    ...
    void mapInfoTilAnnenForelderOpphold() {
        ...
        var behandling = defaultBuilder()
            .fagsakYtelseType(BrevGrunnlag.FagsakYtelseType.FORELDREPENGER)
            .behandlingÅrsakTyper(List.of(BrevGrunnlag.BehandlingÅrsakType.INFOBREV_OPPHOLD))
            .foreldrepengerUttak(foreldrepengerUttakData)
            .build();
        var dokumentFelles = lagStandardDokumentFelles(FagsakYtelseType.FORELDREPENGER);
        var dokumentHendelse = lagStandardHendelseBuilder().medFritekst(null).build();
    ...
    private BrevGrunnlag.ForeldrepengerUttak lagForeldrepengerUttak(LocalDate periode1Fom, LocalDate periode1Tom,
