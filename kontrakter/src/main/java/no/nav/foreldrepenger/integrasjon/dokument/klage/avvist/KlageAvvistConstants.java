package no.nav.foreldrepenger.integrasjon.dokument.klage.avvist;
...
public final class KlageAvvistConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.integrasjon.dokument.klage.avvist.v1";
