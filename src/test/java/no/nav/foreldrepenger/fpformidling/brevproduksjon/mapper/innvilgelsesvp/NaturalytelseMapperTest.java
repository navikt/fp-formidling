...
class NaturalytelseMapperTest {
    ...
    void skal_ikke_utlede_naturalytelse_som_starter_med_første_periode() {
        ...
        var beregningsgrunnlag = getBeregningsgrunnlag(ARBEIDSGIVER_ORGNR, BigDecimal.valueOf(1000), null, of(PeriodeÅrsakDto.NATURALYTELSE_BORTFALT), false);
    ...
    void skal_utlede_at_naturalytelse_bortfaller_når_årsak_er_bortfaller() {
        ...
        var beregningsgrunnlag = getBeregningsgrunnlag(ARBEIDSGIVER_ORGNR, BigDecimal.valueOf(1000), null, of(PeriodeÅrsakDto.NATURALYTELSE_BORTFALT), true);
        ...
        assertThat(resultat.get(0).getArbeidsgiverNavn()).isEqualTo(ARBEIDSGIVER_ORGNR);
    ...
    void skal_utlede_at_naturalytelse_tilkommer_når_årsak_er_tilkommer() {
        // Arrange
        var tilkjentYtelseFP = gettilkjentYtelseFP(ARBEIDSGIVER_ORGNR, true);
        var beregningsgrunnlag = getBeregningsgrunnlag(ARBEIDSGIVER_ORGNR, null, BigDecimal.valueOf(1000), of(PeriodeÅrsakDto.NATURALYTELSE_TILKOMMER), true);
    ...
    private TilkjentYtelseDagytelseDto gettilkjentYtelseFP(String orgnr, boolean inkluderePeriode2) {
        var andel = new TilkjentYtelseDagytelseDto.TilkjentYtelseAndelDto(orgnr, 0, 10,
