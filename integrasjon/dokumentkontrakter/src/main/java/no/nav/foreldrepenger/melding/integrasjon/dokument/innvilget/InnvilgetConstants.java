package no.nav.foreldrepenger.melding.integrasjon.dokument.innvilget;

public final class InnvilgetConstants {

    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.melding.integrasjon.dokumentkontrakter.dokument.innvilget.v1";
