...
class ForeldrepengerOpphørDokumentdataMapperTest {
    ...
    private ForeldrepengerUttak opprettUttaksresultat() {
        var uttakAktivitet = foreldrepengerUttakAktivitet().trekkontoType(ForeldrepengerUttak.TrekkontoType.MØDREKVOTE)
        ...
        return foreldrepengerUttak().stønadskontoer(of())
            .tapteDagerFpff(0)
    ...
    private BrevGrunnlag opprettBehandling(LocalDate opphørsdato, FamilieHendelse familieHendelse) {
