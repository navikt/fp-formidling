...
public class EngangsstønadInnvilgelseDokumentdataMapper implements DokumentdataMapper {
    ...
    private boolean erFBellerMedhold(BrevGrunnlag behandling) {
    ...
    private boolean antallBarnEndret(BrevGrunnlag.FamilieHendelse famHendelse, BrevGrunnlag.FamilieHendelse orgFamhendelse) {
