...
class TilkjentYtelseMapperTest {
    ...
    void skal_finne_at_bruker_har_full_refusjon() {
        // Arrange
        var andel1 = new TilkjentYtelseAndelDto("Referanse1", 100, 100, Aktivitetstatus.ARBEIDSTAKER, null, BigDecimal.valueOf(100), BigDecimal.ZERO);
    ...
    void skal_finne_at_bruker_har_ingen_refusjon() {
        ...
        var andel2 = new TilkjentYtelseAndelDto("Referanse2", 100, 100, Aktivitetstatus.ARBEIDSTAKER, null, BigDecimal.ZERO, BigDecimal.valueOf(100));
    ...
    void skal_finne_at_bruker_har_ingen_refusjon_når_ingen_er_mottakere() {
        // Arrange
        var andel1 = new TilkjentYtelseAndelDto("Referanse1", 100, 100, Aktivitetstatus.ARBEIDSTAKER, null, BigDecimal.ZERO, BigDecimal.ZERO);
        var andel2 = new TilkjentYtelseAndelDto("Referanse2", 100, 100, Aktivitetstatus.ARBEIDSTAKER, null, BigDecimal.ZERO, BigDecimal.ZERO);
