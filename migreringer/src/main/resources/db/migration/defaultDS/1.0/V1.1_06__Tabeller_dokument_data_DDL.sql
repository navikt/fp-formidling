...
(
  ...
  ENDRET_AV                   VARCHAR(20),
  ENDRET_TID                  TIMESTAMP(3),
  GENERISK                    VARCHAR(1)   DEFAULT 'J'            NOT NULL,
...
ALTER TABLE DOKUMENT_MAL_TYPE
  ADD CONSTRAINT CHK_GENERISK CHECK (GENERISK in ('J', 'N'));
...
ALTER TABLE DOKUMENT_FELLES
  ADD CONSTRAINT FK_DOKUMENT_FELLES_1 FOREIGN KEY (MOTTAKER_ADRESSE_ID) REFERENCES DOKUMENT_ADRESSE (ID);
ALTER TABLE DOKUMENT_FELLES
  ADD CONSTRAINT FK_DOKUMENT_FELLES_2 FOREIGN KEY (RETUR_ADRESSE_ID) REFERENCES DOKUMENT_ADRESSE (ID);
ALTER TABLE DOKUMENT_FELLES
  ADD CONSTRAINT FK_DOKUMENT_FELLES_3 FOREIGN KEY (POST_ADRESSE_ID) REFERENCES DOKUMENT_ADRESSE (ID);
ALTER TABLE DOKUMENT_FELLES
...
(
  ID                 bigint,
  VERSJON            bigint       DEFAULT 0,
  DOKSYS_ID          VARCHAR(40)                         NOT NULL,
  VERDI              VARCHAR(4000)                       NOT NULL,
  DOKUMENT_FELLES_ID bigint,
  OPPRETTET_AV       VARCHAR(20)  DEFAULT 'VL'           NOT NULL,
  OPPRETTET_TID      TIMESTAMP(3) DEFAULT localtimestamp NOT NULL,
  ENDRET_AV          VARCHAR(20),
  ENDRET_TID         TIMESTAMP(3),
...
ALTER TABLE DOKUMENT_TYPE_DATA
  ADD CONSTRAINT FK_DOKUMENT_TYPE_DATA_1 FOREIGN KEY (DOKUMENT_FELLES_ID)
