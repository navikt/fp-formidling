package no.nav.foreldrepenger.melding.integrasjon.dokument.uendretutfall;
...
public final class UendretutfallConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.melding.integrasjon.dokumentkontrakter.dokument.uendretutfall.v1";
