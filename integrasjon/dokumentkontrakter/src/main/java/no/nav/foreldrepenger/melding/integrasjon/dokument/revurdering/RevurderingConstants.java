package no.nav.foreldrepenger.melding.integrasjon.dokument.revurdering;
...
public final class RevurderingConstants {
    ...
    public static final String NAMESPACE = "urn:no.nav.foreldrepenger.melding.integrasjon.dokumentkontrakter.dokument.revurdering.v1";
